...
def cancel_activate_physical_card():
    ...
    return PhysicalGiftCardsService.cancel_activate_physical_card(client=sync_client, body=body)
...
async def cancel_activate_physical_card_async():
    ...
    return await PhysicalGiftCardsService.cancel_activate_physical_card_async(client=async_client, body=body)
