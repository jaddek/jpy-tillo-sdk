...
def cancel_top_up_physical_card() -> Response:
    ...
    return PhysicalGiftCardsService.cancel_top_up_on_physical_card(client=sync_client, body=body)
...
async def cancel_top_up_physical_card_async() -> Response:
    ...
    return await PhysicalGiftCardsService.cancel_top_up_on_physical_card_async(client=async_client, body=body)
