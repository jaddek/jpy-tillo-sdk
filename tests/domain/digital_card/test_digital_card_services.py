...
from jpy_tillo_sdk.domain.digital_card.services import IssueDigitalCodeService, IssueDigitalCodeServiceAsync


class TestIssueDigitalCodeServiceAsync:
    @pytest.mark.asyncio
    async def test_issue_digital_code_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.issue_digital_code_async()
    ...
    async def test_check_digital_order_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.check_digital_order_async()
    ...
    async def test_top_up_digital_code_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.top_up_digital_code_async()
    ...
    async def test_cancel_digital_url_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.cancel_digital_url_async()
    ...
    async def test_cancel_digital_code_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.cancel_digital_code_async()
    ...
    async def test_reverse_order_digital_code_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.reverse_digital_code_async()
    ...
    async def test_check_stock_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.check_stock_async()
    ...
    async def test_check_balance_async(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
        response = await service.check_balance_async()
...
class TestIssueDigitalCodeService:
    def test_issue_digital_code(self, mock_http_client):
        service = IssueDigitalCodeService(client=mock_http_client)
