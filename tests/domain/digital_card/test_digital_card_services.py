...
class TestIssueDigitalCodeServiceAsync:
    ...
    @pytest.mark.asyncio
    async def test_top_up_digital_code(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
    ...
    @pytest.mark.asyncio
    async def test_cancel_digital_url(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
    ...
    @pytest.mark.asyncio
    async def test_cancel_digital_code(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
    ...
    @pytest.mark.asyncio
    async def test_reverse_order_digital_code(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
    ...
    @pytest.mark.asyncio
    async def test_check_stock(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
    ...
    @pytest.mark.asyncio
    async def test_check_balance(self, mock_async_http_client):
        service = IssueDigitalCodeServiceAsync(client=mock_async_http_client)
